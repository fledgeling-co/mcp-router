...
| P9 | `make parity-regen` cannot run, so the vectors are unverifiable against the reference | router | — | — | Opus | **To Do** | — | — |
| P10 | A hand-pinned row count went stale; make parity-selftest red on main | parity | — | — | Opus | **To Do** | — | — |
| P11 | Nothing prevents a sixth vector that re-types its reference | parity | — | — | Opus | **To Do** | — | — |
...
| M35 | `mac-shell.sh` hand-names two facts the app has since changed | harness | — | — | Opus | **To Do** | — | — |
...
| G12 | The mutation harness reports success when its filter selects nothing | harness | — | — | Opus | **To Do** | — | — |
| G13 | The pool mutation gate has a guard nothing proves | gate | — | — | Opus | **To Do** | — | — |
...
| G21 | Capture lineage and unpublished-reason catalog | evidence | — | — | Opus | **To Do** | — | — |
| G22 | Campaign effect provider and source-root resolver | evidence | — | — | Opus | **To Do** | — | — |
| G23 | Design-of-record honesty alignment | evidence | — | — | Opus | **To Do** | — | — |
| G24 | 28 cases cite evidence the repo is configured never to hold | evidence | — | — | Opus | **To Do** | — | — |
| G25 | The wave enumerated three surfaces and bound none | evidence | — | — | Opus | **To Do** | — | — |
| G26 | Five armed cases and the floor that would have caught them left in the same stash | evidence | — | — | Opus | **To Do** | — | — |
...
| G29 | Three captures name a route they were not pointed at | evidence | — | — | Opus | **To Do** | — | — |
| G30 | Nothing refuses a registry edit that drops a case | gate | — | — | Opus | **To Do** | — | — |
