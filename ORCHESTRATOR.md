...
| R31 | Invalidate the caches a change outruns | router | — | — | Opus | **Developer Review** | `ai/r31` | `make lint` 0 over 24 members · `make build-cli-debug` 0 · `swift test` 2046/260 with 3 pre-existing `MockToken*` issues this branch touches neither file of · `r31-caches.sh` 36 ok/0 failed, red measured at 13/23 and 32/4 under two restored mutations |
