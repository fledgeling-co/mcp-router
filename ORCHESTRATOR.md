...
| P10 | A hand-pinned row count went stale; make parity-selftest red on main | parity | — | — | Opus | **To Do** | — | — |
...
| G20 | The citation debt the gate surfaced | evidence | — | — | Opus | **To Do** | — | — |
...
| G28 | No surface declares its controls, so the actuation census has no denominator | evidence | — | — | Opus | **To Do** | — | — |
...
| G31 | The reckoning cannot see a merge, so its total is not a progress figure | gate | — | — | Opus | **To Do** | — | — |
| G32 | `.worktrees` resolves two ways, and both failures read as source errors | infra | — | — | Opus | **To Do** | — | — |
...
| G10 | `ai/g10` +7 | NEEDS MORE WORK | Its per-lane table says `fail: 0`/exit 2 where the branch produces `fail: 1`/exit 1; `control-client.sh` exits 0 having run zero assertions |
