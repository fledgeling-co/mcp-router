...
| Menu bar — disabled reasons | 7 `surfaceAbsent` commands present, reporting disabled, carrying `AXHelp` = the reason read out of `MenuCommand.swift` | `8858864` | pass |
| Menu bar — enabled commands | 12 app-declared enabled commands report themselves enabled | `8858864` | pass |
