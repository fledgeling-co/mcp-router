...
177 piece(s) of work remain — 31 product, 16 evidence, 130 decision — across 337 ledger rows. This reckoning speaks for 81/85 (95%) of the campaign's designed cases and 11/25 (44%) of its stated requirements; the rest is not known to be done, it is simply not known. 125 brief(s) could not be tied to the registry at all; they are listed as `unjoined` and counted as decision work, rather than assumed unbuilt.
...
| Briefs joined to evidence | 21 | 146 | 14.4% | the brief could be tied to something in the registry at all. |
...
| `unjoined` | 125 | 125 | decision-work | named in a brief; the join reached nothing, so its state is unknown either way |
...
- **BRIEF-2026-08-26-campaign-reckon-trawl** — Ideation Log — 2026-08-26, from test-campaign + tailings + reckon
  ...
  - nearest the join considered: DEF-057 (0.04), DEF-052 (0.04), DEF-056 (0.04)
...
- **BRIEF-G6-evidence-that-lives-in-tmp-is-not-evidence** — A sweep that proves a guard is armed, kept in `/tmp`
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-001 (0.04), REQ-019 (0.03), REQ-012 (0.03)
