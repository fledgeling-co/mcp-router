...
- **One skill is vendored; four are machine dependencies.** `vendor/test-campaign/` carries
  ...
  `effect-witness` rung and silently drops all four such cases. 0.9.2 and the installed 0.9.4 both
