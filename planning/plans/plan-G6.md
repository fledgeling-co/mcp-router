...
- **`/tmp` is cited in durable specs, not only in progress docs.** `planning/specs/spec-P4.md`
  at 43, 85, 300; "effort, read-only, wire-verified — `/tmp/gate-F1-critic.md`), whose verdict on the first", `planning/specs/spec-F1.md:166` at `c4b75bd`; and six further specs the brief never names
