...
190 piece(s) of work remain — 37 product, 16 evidence, 137 decision — across 385 ledger rows. This reckoning speaks for 110/114 (96%) of the campaign's designed cases and 13/27 (48%) of its stated requirements; the rest is not known to be done, it is simply not known. 128 brief(s) could not be tied to the registry at all; they are listed as `unjoined` and counted as decision work, rather than assumed unbuilt.
...
| Briefs joined to evidence | 28 | 156 | 17.9% | the brief could be tied to something in the registry at all. |
...
| `unjoined` | 128 | 128 | decision-work | named in a brief; the join reached nothing, so its state is unknown either way |
| `broken` | 36 | 43 | product-work | measured, and the answer was no |
| `unmeasured` | 16 | 17 | evidence-work | nobody found out — the work here is becoming able to tell |
| `undecided` | 9 | 9 | decision-work | the documents and the evidence disagree; needs a person |
...
- **BRIEF-D1-deferred-router** — D1 — The deferred register: router side
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.11), REQ-019 (0.07), REQ-026 (0.06)
- **BRIEF-D2-deferred-mac** — D2 — The deferred register: Mac surfaces and the design authority
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.10), REQ-026 (0.06), REQ-019 (0.05)
...
- **BRIEF-D3-deferred-phone-harness** — D3 — The deferred register: phone copy, and the harness limit
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.10), REQ-019 (0.06), REQ-026 (0.06)
...
- **BRIEF-F1-swift-workspace** — F1 — Swift workspace, shared kit, and the three targets
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-024 (0.05), REQ-027 (0.04), REQ-013 (0.04)
- **BRIEF-F2-design-system** — F2 — The design system in SwiftUI
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.04), REQ-019 (0.04), REQ-026 (0.04)
...
- **BRIEF-F4-tracker-failure-states** — F4 — ServerStateTracker cannot report failure
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.08), REQ-019 (0.07), REQ-017 (0.04)
- **BRIEF-G1-gate-hygiene** — G1 — Stop the checks blaming the app for being out of date
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.07), REQ-019 (0.05), REQ-003 (0.04)
...
- **BRIEF-G3-make-test-is-not-deterministic** — G3 — `make test` is green on the second run, which is not a gate
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.10), REQ-019 (0.06), REQ-001 (0.06)
- **BRIEF-G4-assertions-that-do-not-read-their-own-quantity** — G4 — assertions that do not read the quantity they are named for
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.11), REQ-026 (0.07), REQ-019 (0.04)
...
- **BRIEF-I2-ios-discover** — I2 — iPhone: Discover and detail
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-016 (0.06), SURF-028 (0.06), DEF-008 (0.05)
- **BRIEF-I3-ios-triage** — I3 — iPhone: Triage, Queue, Library, Settings
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.06), REQ-010 (0.06), REQ-016 (0.05)
...
- **BRIEF-M1-mac-shell** — M1 — Mac window shell, menu bar commands, keyboard
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-001 (0.08), REQ-005 (0.06), REQ-027 (0.05)
...
- **BRIEF-M13-scroll-edge** — M13 — The scroll-edge separator, A34
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.05), REQ-012 (0.05), DEF-018 (0.04)
- **BRIEF-M14-menu-says-not-built** — M14 — a shipped menu tells the user the app is not built
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-019 (0.09), REQ-027 (0.07), REQ-012 (0.05)
...
- **BRIEF-M15-settings-window** — M15 — Settings becomes its own window
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.07), REQ-001 (0.05), REQ-012 (0.04)
- **BRIEF-M16-signal-path** — M16 — the Signal Path replaces the Breaker Column
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.08), REQ-001 (0.06), REQ-019 (0.04)
- **BRIEF-M17-surface-states** — M17 — four states on every surface, and chrome that follows them
  - the join could not tie this brief to anything in the registry. That is not evidence that it was never built — it is the inferential step of this pipeline returning nothing, and a person has to read the brief and rule
  - nearest the join considered: REQ-027 (0.09), REQ-026 (0.06), REQ-001 (0.05)
...
- **BRIEF-R15-host-check-is-scoped-to-the-mcp-transport** — R15 — the Host check guards `/mcp` and nothing else
  - looks done, but the strongest oracle behind it is 'none', below the 'outcome' floor for retiring intent; and the join as a whole is too weak to carry a retirement claim — route to spec-validation before retiring
- **BRIEF-five-armed-cases-and-the-floor-that-would-have-caught-it** — Five armed cases and the floor that would have caught them left in the same stash
  - looks done, but the join as a whole is too weak to carry a retirement claim — route to spec-validation before retiring
- **BRIEF-the-document-route-has-no-wire-level-campaign-case** — The document route has no wire-level campaign case
  - looks done, but the strongest oracle behind it is 'none', below the 'outcome' floor for retiring intent; and the join as a whole is too weak to carry a retirement claim — route to spec-validation before retiring
- **BRIEF-the-relabel-gate-cannot-fire-on-any-ledger-it-writes** — The remaining-work gate against re-labelling cannot fire on any ledger it writes
  - looks done, but the strongest oracle behind it is 'none', below the 'outcome' floor for retiring intent; and the join as a whole is too weak to carry a retirement claim — route to spec-validation before retiring
- **BRIEF-the-wave-enumerated-three-surfaces-and-bound-none** — The wave enumerated three surfaces and bound none, so the gate it was measured by got worse
  - looks done, but the join as a whole is too weak to carry a retirement claim — route to spec-validation before retiring
