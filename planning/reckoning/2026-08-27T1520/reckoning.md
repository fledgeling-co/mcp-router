...
189 piece(s) of work remain — 35 product, 16 evidence, 138 decision — across 375 ledger rows. This reckoning speaks for 105/109 (96%) of the campaign's designed cases and 13/27 (48%) of its stated requirements; the rest is not known to be done, it is simply not known. 127 brief(s) could not be tied to the registry at all; they are listed as `unjoined` and counted as decision work, rather than assumed unbuilt.

## What it can speak for

| Axis | Measured | Of | % | What the number means |
|---|---:|---:|---:|---|
| Cases adjudicated | 105 | 109 | 96.3% | an instrument returned a verdict on the product — pass or fail. A fail is knowledge; this is not a pass rate. |
| Cases ruled out by decision | 4 | 109 | 3.7% | somebody ruled the cell out of scope or not applicable. A decision, not a measurement, and it is kept out of the line above on purpose. |
| Requirements observed | 13 | 27 | 48.1% | somebody watched it happen, rather than the project reporting it of itself. |
| Surfaces spoken for | 23 | 28 | 82.1% | at least one case on this surface reached a verdict. |
| Briefs joined to evidence | 24 | 151 | 15.9% | the brief could be tied to something in the registry at all. |
...
| `unjoined` | 127 | 127 | decision-work | named in a brief; the join reached nothing, so its state is unknown either way |
| `broken` | 34 | 41 | product-work | measured, and the answer was no |
| `unmeasured` | 16 | 17 | evidence-work | nobody found out — the work here is becoming able to tell |
| `unnamed` | 4 | 4 | decision-work | the campaign found it; no document claims it |
| `undecided` | 7 | 7 | decision-work | the documents and the evidence disagree; needs a person |
| `waived` | 0 | 4 | exception | somebody decided not to — an exception, and it stays visible |
| `verified-done` | 0 | 174 | none | not remaining; kept so the denominator is honest |
...
- **SURF-021** — OAuth discovery and dynamic client registration
  - the campaign found this surface; no brief and no requirement claims it
- **SURF-022** — The /authorize consent interstitial and its upstream report
  - the campaign found this surface; no brief and no requirement claims it
- **SURF-023** — The /token grant handler — authorization_code and refresh_token
  - the campaign found this surface; no brief and no requirement claims it
- **SURF-024** — The authority guard ahead of the dispatch ladder
  - the campaign found this surface; no brief and no requirement claims it
